...
const Home = () => {
    ...
    return (
        ...
        <div className="">
            ...
            <div className="flex flex-col space-y-12 md:px-20 md:mr-16 sm:px-10 sm:mr-5 lg:px-45 items-center overflow-auto">
                <div className="flex flex-row space-x-8 items-center">
                    <img src={image} alt="picture of Nathaniel Judd"
                         className="rounded-full w-1/4 h-fit"
                    />
                ...
                <div className="flex flex-row space-x-8 items-center">
                    <img src={famImage} alt="picture of Nathaniel Judd with family"
                         className="rounded-lg w-1/4 h-fit"
                    />
                    <span className="h-full bg-gray-800 text-xl rounded-lg p-2 mt-8">
                        <b>About Me:</b>
                        <br />
